...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        ...
        self.entry_sel = ttk.Entry(self)
        self.entry_sel.place(x=200, y=140)
        ...
        self.btn_ok.bind(
            ...
            lambda event: self.view.records(
                self.entry_name.get(), self.entry_email.get(), self.entry_tel.get(), self.entry_sel.get()
            ),
        )
